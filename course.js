...
window.customElements.define("header-course", Header)
window.customElements.define("login-course", PopupLogin)
window.customElements.define("hambergur-course", HambergurMenu)
window.customElements.define("cart-course", CartItem)
window.customElements.define("footer-course", Footer)
window.customElements.define("topBar-course", TopBar)
